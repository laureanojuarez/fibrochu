...
export default function ProductCard({ producto }) {
  ...
  return (
    <div className="bg-gray-dark rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all flex flex-col w-42 md:w-52  border border-gray-800 hover:border-primary group justify-between">
      <img
